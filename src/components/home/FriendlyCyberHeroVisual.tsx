...
export function FriendlyCyberHeroVisual() {
  return (
    <div className="relative mx-auto w-full max-w-xl">
      <div className="absolute -left-8 top-10 h-28 w-28 rounded-full bg-[var(--app-primary)]/20 blur-3xl" />
      <div className="absolute -right-8 bottom-10 h-32 w-32 rounded-full bg-[var(--app-success)]/20 blur-3xl" />
      ...
      <div className="relative overflow-hidden rounded-lg border border-[var(--app-border)] bg-[var(--app-surface)] p-5 shadow-2xl shadow-[var(--app-shadow)]">
        ...
        <div className="relative">
          <div className="flex items-center justify-between gap-4 rounded border border-[var(--app-border)] bg-[var(--app-surface-elevated)] p-4">
            ...
            <ShieldCheck className="h-7 w-7 text-[var(--app-success)] dark:text-[var(--app-success)]" />
          </div>
          ...
          <div className="mt-5 rounded border border-[var(--app-primary)]/25 bg-[var(--app-primary)]/10 p-4">
            <div className="flex items-center gap-3">
              <span className="grid h-10 w-10 place-items-center rounded-full bg-[var(--app-surface)] text-[var(--app-primary)] dark:text-[var(--app-primary-dark)]">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <p className="font-mono text-xs font-black text-[var(--app-primary)] dark:text-[var(--app-primary-dark)]">
                    5 fases
                  </p>
                </div>
                <div className="mt-3 h-2 overflow-hidden rounded-full bg-[var(--app-bg-muted)]">
                  <div className="h-full w-3/4 rounded-full bg-[var(--app-primary)]" />
                </div>
              </div>
            </div>
          </div>

          <div className="mt-5 flex items-center justify-center gap-2 rounded border border-[color:var(--app-success)]/25 bg-[var(--app-success-soft)] px-4 py-3 text-sm font-bold text-[var(--app-success)] dark:text-[var(--app-success)]">
