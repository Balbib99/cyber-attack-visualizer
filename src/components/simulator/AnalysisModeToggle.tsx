        ...
        {options.map((option) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-3 rounded-md border px-3 py-2.5 text-left transition focus:outline-none focus:ring-2 focus:ring-[var(--app-primary)]/60 ${
                isActive
                  ? "border-[var(--app-primary)]/45 bg-[var(--app-primary)]/12 text-[var(--app-primary)] shadow-sm dark:text-[var(--app-primary-dark)]"
            ...
            >
              <span
                className={`grid h-9 w-9 shrink-0 place-items-center rounded border ${
                  isActive
                    ? "border-[var(--app-primary)]/35 bg-[var(--app-primary)]/10"
