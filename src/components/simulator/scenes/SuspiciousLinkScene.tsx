      ...
      <div className="mx-auto max-w-3xl space-y-5">
        <div className="rounded-lg border border-white/10 bg-[var(--app-surface-elevated)] p-5">
          <div className="flex items-center gap-3">
            <Link2 className="h-5 w-5 text-[var(--app-primary-dark)]" />
            <span className="font-bold text-white">Destino del enlace</span>
          </div>
          <div className="mt-5 rounded border border-white/10 bg-[var(--app-surface-elevated)] p-4 font-mono text-sm text-slate-300">
          ...
          <motion.div
            ...
            className={`mt-3 h-1 rounded ${
              mode === "defense" ? "bg-[var(--app-success)]" : "bg-[var(--app-warning)]"
            }`}
          />
        </div>
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded border border-[var(--app-warning)]/25 bg-[var(--app-warning)]/10 p-4">
            <MousePointerClick className="h-5 w-5 text-[var(--app-warning)]" />
          ...
          <div className="rounded border border-[var(--app-success)]/25 bg-[var(--app-success)]/10 p-4">
            <Link2 className="h-5 w-5 text-[var(--app-success)]" />
